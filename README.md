 ...
 * To ensure distinct patron activity can be queried, `patron_id` is encrypted using a closely guarded cryptographic [salt](https://en.wikipedia.org/wiki/Salt_(cryptography)).
...
|----------------------------|----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| `patron_id`                | `VARCHAR(31)`  | Obfuscated patron id                                                                                                                                                                                                                                                                                                                                                                                                       | `Sw0A74bw1YxANttZZO3XmMhrJpdW6yy`        |
