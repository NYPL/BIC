...
The data has been modified to ensure that it's essentially impossible to derive any individual patron's detailed transaction history. We do this through obfuscation and generalization.

### Obfuscation

We include two obfucated values from the original transaction:
...
|----------------------------|----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| `uuid`                | `VARCHAR(36)`  | Unique id for record in Redshift                                                                                                                                                                                                                                                                                                                                                                                                       | `510d47dd-2f95-a3d9-e040-e00a18064a99`        |
| `transaction_checksum`                | `VARCHAR(100)`  | Unique id built from identifiers in source transaction record                                                                                                                                                                                                                                                                                                                                                                                                    | `Sw0A74bw1YxANttZZO3XmMhrJpdW6yy`        |
| `patron_id`                | `VARCHAR(100)`  | Obfuscated patron id                                                                                                                                                                                                                                                                                                                                                                                                       | `Sw0A74bw1YxANttZZO3XmMhrJpdW6yy`        |
| `ptype_code`               | `SMALLINT`     | Patron ["ptype"](https://docs.google.com/spreadsheets/d/1YUZuG8yGS-7kW2uG2eU5K4YWThH-DN8_ucqJaDCAvw4/edit#gid=0&range=A3)                                                                                                                                                                                                                                                                                                  | `10`                                   |
| `patron_home_library_code` | `VARCHAR(5)`   | A five-character location code, from the associated patron record.                                                                                                                                                                                                                                                                                                                               | `sa`                                   |
| `pcode3`                   | `SMALLINT`     | Patron ["home region"](https://docs.google.com/spreadsheets/d/1YUZuG8yGS-7kW2uG2eU5K4YWThH-DN8_ucqJaDCAvw4/edit#gid=1206057186) code                                                                                                                                                                                                                                                                                            | `2`                                    |
| `postal_code`              | `VARCHAR(5)`?  | Patron postal code                                                                                                                                                                                                                                                                                                                                                                                                         | `11222`                                |
| `geoid`                    | `VARCHAR(11)`? | Patron census tract (placeholder; not currently queried)     | `561`                                |
| `itype_code_num`           | `SMALLINT`     | [Item Type](https://docs.google.com/spreadsheets/d/1YUZuG8yGS-7kW2uG2eU5K4YWThH-DN8_ucqJaDCAvw4/edit#gid=580006046&range=A1) code                                                                                                                                                                                                                                                                                              | `101` (Book, circ)                     |
| `item_location_code`       | `VARCHAR(5)`   | A five-character [location code](https://docs.google.com/spreadsheets/d/1YUZuG8yGS-7kW2uG2eU5K4YWThH-DN8_ucqJaDCAvw4/edit#gid=2039183095&range=A1), from the associated item record.                                                                                                                                                                                                             | `maj0f`                                |
| `icode1`                   | `INTEGER`      | Item ["icode1"](https://docs.google.com/spreadsheets/d/1YUZuG8yGS-7kW2uG2eU5K4YWThH-DN8_ucqJaDCAvw4/edit#gid=333228251&range=A1) where '-' is converted to `1` and anything else is cast to an integer | `1` |
...
| `transaction_et`          | `DATE`         | Transaction date (ISO 8601 date without time in ET)                                                                                                                                                                                                                                                                                                                                                                                            | `2019-11-15`                           |
| `due_date_et`             | `DATE`         | Due date (ISO 8601 date without time in ET) The application of this date depends on the `op_code` for the transaction. The due date is not included for bookings (`op_code` `b`) or filled holds (`op_code` `f`). For `op_code` `i` (checkin), this is the original due date. For `op_code` `r` (renewal), this is the renewal due date. For `op_code` `o` (checkouts), this is the item due date. For `op_code` `n` (holds) and `h` (holds with recall), a non-zero entry indicates that the hold is for a checked-out item that is due on the specified date.                                                                                                                                                                                                                                                                                                                                             | `2019-11-29`                           |
...
| `source_code`              | `VARCHAR(200)` | The transaction source. Possible values are: `local`, `INN-Reach`, `ILL`                                                                                                                                                                                                                                                                                                                                                           | `local`                                    |
